...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='CAST for Climate Transportation')

    # Basic Config
    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='CAST', help='model name')
    ...
    parser.add_argument('--d_core', type=int, default=512, help='dimension of core state (SOFTS)')
